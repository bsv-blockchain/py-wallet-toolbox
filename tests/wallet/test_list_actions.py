...
Reference: toolbox/ts-wallet-toolbox/test/wallet/list/listActions.test.ts
"""
...
class TestWalletListActions:
    ...
    async def test_invalid_params_label_too_long(self, wallet: Wallet) -> None:
        ...
        # Given
        invalid_args = {
            "labels": ["toolong890" * 31]  # Exceeds 300 character limit
        }
    ...
    async def test_non_existing_label_with_any(self, wallet: Wallet) -> None:
        ...
        args = {
            "includeLabels": True,
            "labels": ["xyzzy"],  # Non-existing label
            "labelQueryMode": "any"
        }
