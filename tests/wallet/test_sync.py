...
Reference: toolbox/ts-wallet-toolbox/test/wallet/sync/Wallet.sync.test.ts
"""
...
class TestWalletSyncToWriter:
    ...
    @pytest.mark.asyncio
    async def test_sync_initial_then_no_changes_then_one_change(self, wallet: Wallet) -> None:
...
class TestWalletSetActive:
    ...
    @pytest.mark.asyncio
    async def test_set_active_to_backup_and_back_without_backup_first(self, wallet: Wallet) -> None:
    ...
    @pytest.mark.skip(reason="Waiting for set_active implementation with test database")
    @pytest.mark.asyncio
    async def test_set_active_to_backup_and_back_with_backup_first(self, wallet: Wallet) -> None:
