...
class TestWalletCreateHmac:
    ...
    @pytest.mark.asyncio
    async def test_create_hmac(self, wallet: Wallet) -> None:
        ...
        # When
        result = await wallet.create_hmac(args)
...
class TestWalletVerifyHmac:
    ...
    @pytest.mark.asyncio
    async def test_verify_hmac_valid(self, wallet: Wallet) -> None:
        ...
        create_result = await wallet.create_hmac(create_args)
        ...
        # When
        result = await wallet.verify_hmac(verify_args)
    ...
    @pytest.mark.skip(reason="Waiting for verify_hmac implementation")
    @pytest.mark.asyncio
    async def test_verify_hmac_invalid(self, wallet: Wallet) -> None:
...
class TestWalletCreateSignature:
    ...
    @pytest.mark.asyncio
    async def test_create_signature(self, wallet: Wallet) -> None:
        ...
        # When
        result = await wallet.create_signature(args)
...
class TestWalletVerifySignature:
    ...
    @pytest.mark.asyncio
    async def test_verify_signature_valid(self, wallet: Wallet) -> None:
        ...
        create_result = await wallet.create_signature(create_args)

        # Get public key for verification
        pubkey_result = await wallet.get_public_key({"protocolID": [0, "test protocol"], "keyID": "signing_key_1"})
        ...
        # When
        result = await wallet.verify_signature(verify_args)
    ...
    @pytest.mark.skip(reason="Waiting for verify_signature implementation")
    @pytest.mark.asyncio
    async def test_verify_signature_invalid(self, wallet: Wallet) -> None:
