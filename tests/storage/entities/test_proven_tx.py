...
class TestProvenTxEntity:
    ...
    async def test_fromtxid_valid_txid_with_rawtx_and_merkle_proof_real_database(self) -> None:
        ...
        mock_services = type("MockServices", (), {
            "get_raw_tx": mock_get_raw_tx,
            "get_merkle_path": mock_get_merkle_path
        })()
    ...
    def test_equals_identifies_non_matching_syncmap(self) -> None:
        ...
        sync_map = {
            "provenTx": {"idMap": {108: 999}}  # Mismatched mapping
        }
    ...
    async def test_mergeexisting_always_returns_false(self) -> None:
        ...
        # When
        result = await proven_tx.merge_existing(
            mock_storage, 
            datetime.now(), 
            proven_tx.to_api(), 
            sync_map, 
