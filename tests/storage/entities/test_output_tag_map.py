...
class TestOutputTagMapEntity:
    ...
    async def test_mergeexisting_merges_and_updates_entity_when_ei_updated_at_greater_than_this_updated_at_at(
        ...
        was_merged = await entity.merge_existing(
            mock_storage, None, updated_data, sync_map
        )
    ...
    @pytest.mark.skip(reason="OutputTagMap entity not implemented yet")
    @pytest.mark.asyncio
    async def test_mergeexisting_does_not_merge_when_ei_updated_at_less_than_or_equal_this_updated_at_at(
        self
    ) -> None:
        ...
        # When
        was_merged = await entity.merge_existing(
            mock_storage, None, earlier_data, sync_map
        )
