...
class Testinsert:
    ...
    async def test_insert_proventx(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "insert_proven_tx": lambda self, ptx: None
        })()
    ...
    async def test_insert_proventxreq(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "insert_proven_tx_req": lambda self, ptxreq: None
        })()
    ...
    async def test_insert_user(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "insert_user": lambda self, user: None
        })()
    ...
    async def test_insert_certificate(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "insert_certificate": lambda self, cert: None
        })()
    ...
    async def test_insert_certificatefield(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "insert_certificate_field": lambda self, field: None
        })()
    ...
    async def test_insert_outputbasket(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "insert_output_basket": lambda self, basket: None
        })()
    ...
    async def test_insert_transaction(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "insert_transaction": lambda self, tx: None
        })()
    ...
    async def test_insert_commission(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "insert_commission": lambda self, comm: None
        })()
    ...
    async def test_insert_output(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "insert_output": lambda self, output: None
        })()
    ...
    async def test_insert_outputtag(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "insert_output_tag": lambda self, tag: None
        })()
    ...
    async def test_insert_outputtagmap(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "insert_output_tag_map": lambda self, tagmap: None
        })()
    ...
    async def test_insert_txlabel(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "insert_tx_label": lambda self, label: None
        })()
    ...
    async def test_insert_txlabelmap(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "insert_tx_label_map": lambda self, labelmap: None
        })()
    ...
    async def test_insert_monitorevent(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "insert_monitor_event": lambda self, event: None
        })()
    ...
    async def test_insert_syncstate(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "insert_sync_state": lambda self, state: None
        })()
