...
class Testupdate:
    ...
    async def test_update_proventxreq(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "update_proven_tx_req": lambda self, id, updates: None
        })()
    ...
    async def test_update_user(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "update_user": lambda self, id, updates: None
        })()
    ...
    async def test_update_certificate(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "update_certificate": lambda self, id, updates: None
        })()
    ...
    async def test_update_certificatefield(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "update_certificate_field": lambda self, cert_id, user_id, field_name, updates: None
        })()
        
        test_values = {
            "fieldValue": "updated_value",
            "masterKey": "updated_master"
        }
    ...
    async def test_update_outputbasket(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "update_output_basket": lambda self, id, updates: None
        })()
    ...
    async def test_update_transaction(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "update_transaction": lambda self, id, updates: None
        })()
    ...
    async def test_updatetransactionstatus(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "update_transaction_status": lambda self, id, status: None
        })()
    ...
    async def test_update_commission(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "update_commission": lambda self, id, updates: None
        })()
    ...
    async def test_update_output(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "update_output": lambda self, id, updates: None
        })()
    ...
    async def test_update_outputtag(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "update_output_tag": lambda self, id, updates: None
        })()
    ...
    async def test_update_outputtagmap(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "update_output_tag_map": lambda self, output_id, tag_id, updates: None
        })()
    ...
    async def test_update_txlabel(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "update_tx_label": lambda self, id, updates: None
        })()
    ...
    async def test_update_txlabelmap(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "update_tx_label_map": lambda self, tx_id, label_id, updates: None
        })()
    ...
    async def test_update_monitorevent(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "update_monitor_event": lambda self, id, updates: None
        })()
    ...
    async def test_update_syncstate(self) -> None:
        ...
        mock_storage = type("MockStorage", (), {
            "update_sync_state": lambda self, id, updates: None
        })()
        
        test_values = {
            "storageIdentityKey": "05" + "2" * 64
        }
