...
class TestWalletGetVersion:
    ...
    @pytest.mark.asyncio
    async def test_get_version_returns_correct_version(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_version_with_valid_originator(self) -> None:
        """Given: A wallet
    ...
    @pytest.mark.asyncio
    async def test_get_version_with_invalid_originator_type(self) -> None:
        """Given: A wallet
    ...
    @pytest.mark.asyncio
    async def test_get_version_with_too_long_originator(self) -> None:
        """Given: A wallet
    ...
    @pytest.mark.asyncio
    async def test_get_version_result_type(self) -> None:
        """Given: A wallet
        When: get_version is called
