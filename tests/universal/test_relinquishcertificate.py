...
class TestUniversalVectorsRelinquishCertificate:
    ...
    @pytest.mark.asyncio
    async def test_relinquishcertificate_json_matches_universal_vectors(
        ...
        # When
        result = await wallet.relinquish_certificate(args_data["json"], originator=None)
    ...
    @pytest.mark.asyncio
    async def test_relinquishcertificate_wire_matches_universal_vectors(
        self, load_test_vectors: Callable[[str], tuple[dict, dict]]
    ) -> None:
