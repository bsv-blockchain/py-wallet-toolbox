...
Reference: toolbox/go-wallet-toolbox/pkg/internal/validate/validate_insert_certificate_auth_args_test.go
"""
...
class TestValidateInsertCertificateAuthArgs:
    ...
    @pytest.mark.skip(reason="Waiting for validate_insert_certificate_auth_args implementation")
    ...
    def test_validate_insert_certificate_auth_args_field_invalid_master_key(self) -> None:
        ...
        invalid_args = {
            ...
            "fields": [
                {
                    "fieldName": "field1",
                    "masterKey": "invalidhex"  # Non-hex characters
                }
            ]
        }
