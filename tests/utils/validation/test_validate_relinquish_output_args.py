...
Reference: toolbox/go-wallet-toolbox/pkg/internal/validate/validate_relinquish_output_args_test.go
"""
...
class TestValidateRelinquishOutputArgs:
    ...
    def test_validate_relinquish_output_args_basket_max_length(self) -> None:
        ...
        valid_args = {
            "output": "deadbeefcafebabe" + "0" * 48 + ".0",
            "basket": "a" * 300  # Max length (300 chars)
        }
    ...
    def test_validate_relinquish_output_args_empty_basket(self) -> None:
        ...
        valid_args = {
            "output": "deadbeefcafebabe" + "0" * 48 + ".0",
            "basket": ""  # Empty basket is allowed
        }
    ...
    def test_validate_relinquish_output_args_missing_dot(self) -> None:
        ...
        invalid_args = {
            "output": "deadbeefcafebabe0",  # Missing dot separator
            "basket": "validbasket"
        }
    ...
    def test_validate_relinquish_output_args_index_not_numeric(self) -> None:
        ...
        invalid_args = {
            "output": "deadbeefcafebabe.notanumber",  # Index not numeric
            "basket": "validbasket"
        }
