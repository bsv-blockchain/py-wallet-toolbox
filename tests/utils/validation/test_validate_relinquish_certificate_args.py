...
Reference: toolbox/go-wallet-toolbox/pkg/internal/validate/validate_relinquish_certificate_args_test.go
"""
...
class TestValidateRelinquishCertificateArgs:
    ...
    def test_validate_relinquish_certificate_args_invalid_certifier_non_hex(self) -> None:
        ...
        invalid_args = {
            "type": "dGVzdA==",
            "serialNumber": "c2VyaWFs",
            "certifier": "ghijk!"  # Non-hex characters
        }
