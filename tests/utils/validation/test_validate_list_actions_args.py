...
Reference: toolbox/go-wallet-toolbox/pkg/internal/validate/validate_list_actions_args_test.go
"""
...
class TestValidateListActionsArgs:
    ...
    def test_validate_list_actions_args_limit_exceeds_max(self) -> None:
        ...
        invalid_args = {
            "limit": 10001  # Exceeds typical MaxPaginationLimit of 10000
        }
    ...
    def test_validate_list_actions_args_offset_exceeds_max(self) -> None:
        ...
        invalid_args = {
            "offset": 1000001  # Exceeds typical MaxPaginationOffset of 1000000
        }
    ...
    def test_validate_list_actions_args_invalid_label_query_mode(self) -> None:
        ...
        invalid_args = {
            "labelQueryMode": "unknown"  # Invalid mode (must be "any", "all", or empty)
        }
    ...
    def test_validate_list_actions_args_seek_permission_false(self) -> None:
        ...
        invalid_args = {
            "seekPermission": False  # Must be True
        }
    ...
    def test_validate_list_actions_args_label_too_long(self) -> None:
        ...
        invalid_args = {
            "labels": ["x" * 301]  # 301 characters (exceeds 300 limit)
        }
