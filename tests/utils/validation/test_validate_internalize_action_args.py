...
Reference: toolbox/go-wallet-toolbox/pkg/internal/validate/validate_internize_action_args_test.go
"""
...
class TestValidateInternalizeActionArgs:
    ...
    @pytest.mark.skip(reason="Waiting for validate_internalize_action_args implementation")
            ...
            "outputs": [
                {
                    ...
                    "paymentRemittance": {
                        "derivationPrefix": "AAAA",  # Valid base64
                        "derivationSuffix": "BBBB"
                    }
                }
            ],
            ...
            "outputs": [
                {
                    "outputIndex": 0,
                    "protocol": "wallet payment",
                    "paymentRemittance": None  # Missing remittance
                }
            ],
            "description": "Test"
        }
