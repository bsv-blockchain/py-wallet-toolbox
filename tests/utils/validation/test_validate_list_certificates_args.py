...
Reference: toolbox/go-wallet-toolbox/pkg/internal/validate/validate_list_certificates_args_test.go
"""
...
class TestValidateListCertificatesArgs:
    ...
    @pytest.mark.skip(reason="Waiting for validate_list_certificates_args implementation")
    ...
    def test_validate_list_certificates_args_invalid_certifier_non_hex(self) -> None:
        ...
        invalid_args = {
            "certifiers": ["invalid!"]  # Non-hex characters
        }
    ...
    def test_validate_list_certificates_args_invalid_type_not_base64(self) -> None:
        ...
        invalid_args = {
            "types": ["not@base64!"]  # Invalid base64 characters
        }
    ...
    def test_validate_list_certificates_args_partial_invalid_certifier(self) -> None:
        ...
        invalid_args = {
            "partial": {
                "certifier": "zzzz"  # Non-hex characters
            }
        }
    ...
    def test_validate_list_certificates_args_partial_malformed_outpoint(self) -> None:
        ...
        invalid_args = {
            "partial": {
                "revocationOutpoint": "missing.index"  # Malformed outpoint
            }
        }
