...
Reference: toolbox/go-wallet-toolbox/pkg/internal/validate/validate_basket_config_test.go
"""
...
class TestValidateBasketConfig:
    ...
    def test_validate_basket_config_name_too_long(self) -> None:
        ...
        invalid_config = {
            "name": "a" * 301  # 301 bytes (exceeds 300 limit)
        }
