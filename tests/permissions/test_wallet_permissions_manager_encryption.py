...
Reference: toolbox/ts-wallet-toolbox/src/__tests/WalletPermissionsManager.encryption.test.ts
"""
...
class TestWalletPermissionsManagerEncryptionHelpers:
    ...
    @pytest.mark.asyncio
    async def test_should_call_underlying_encrypt_with_correct_protocol_and_key_when_encryptwalletmetadata_true(self) -> None:
    ...
    @pytest.mark.skip(reason="Waiting for WalletPermissionsManager implementation")
    @pytest.mark.asyncio
    async def test_should_call_underlying_decrypt_with_correct_protocol_and_key_returning_plaintext_on_success(self) -> None:
...
class TestWalletPermissionsManagerEncryptionIntegration:
    ...
    @pytest.mark.skip(reason="Waiting for WalletPermissionsManager implementation")
    @pytest.mark.asyncio
    async def test_should_encrypt_metadata_fields_in_createaction_when_encryptwalletmetadata_true_then_decrypt_them_in_listactions(self) -> None:
        """Given: WalletPermissionsManager with encryptWalletMetadata=True
        ...
        underlying.list_actions = AsyncMock(return_value={
            "totalActions": 1,
            "actions": [{
                ...
                "outputs": [{
                    ...
                    "customInstructions": base64.b64encode(b"fake-encrypted-string-for-customInstr").decode()
                }]
            }]
        })
    ...
    @pytest.mark.skip(reason="Waiting for WalletPermissionsManager implementation")
    @pytest.mark.asyncio
    async def test_should_not_encrypt_metadata_if_encryptwalletmetadata_false_storing_and_retrieving_plaintext(self) -> None:
        """Given: WalletPermissionsManager with encryptWalletMetadata=False
...
class TestWalletPermissionsManagerListOutputsDecryption:
    ...
    async def test_should_decrypt_custominstructions_in_listoutputs_if_encryptwalletmetadata_true(self) -> None:
        ...
        underlying.list_outputs = AsyncMock(return_value={
            "totalOutputs": 1,
            "outputs": [{
                "outpoint": "fakeTxid.0",
                "satoshis": 999,
