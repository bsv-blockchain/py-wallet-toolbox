...
class CreateActionTransactionAssembler:
    ...
    def _to_tx_input_from_args(
        self,
        storage_input: StorageCreateTransactionSdkInput
    ) -> TransactionInput:
    ...
    def _to_tx_output(self, storage_output: StorageCreateTransactionSdkOutput) -> TransactionOutput:
        ...
        is_change = (
            storage_output.provided_by == "storage" and
            storage_output.purpose == "change"
        )
