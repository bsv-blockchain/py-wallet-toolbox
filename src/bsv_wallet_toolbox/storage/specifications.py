...
# CRUD Specifications for entity accessors
@dataclass
class Comparable(Generic[T]):
    ...
    def is_empty(self) -> bool:
        """Check if this comparable is empty/unset."""
        return self.value is None or (isinstance(self.value, (list, str)) and len(self.value) == 0)
...
class CertificateReadSpecification:
    ...
    subject: Comparable[str] | None = None
